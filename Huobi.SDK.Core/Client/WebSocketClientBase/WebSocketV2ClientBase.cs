...
namespace Huobi.SDK.Core.Client.WebSocketClientBase
{
    ...
    public abstract class WebSocketV2ClientBase<DataResponseType> : AbstractWebSocketClient where DataResponseType : WebSocketV2ResponseBase
    {
        ...
        public WebSocketV2ClientBase(string accessKey, string secretKey,string sign, string host = DEFAULT_HOST)
        {
            _host = host;
            ...
            _wsV2ReqBuilder = new WebSocketV2RequestBuilder(accessKey, secretKey, host, PATH,sign);
        }
